    ...
    def self.plain_options
      [
        ...
        FastlaneCore::ConfigItem.new(key: :xcpretty_utf,
                                     ...
                                     optional: true,
                                     type: Boolean),
        FastlaneCore::ConfigItem.new(key: :using_xcodebuild_appstore_upload,
                                     env_name: "GYM_USING_XCODEBUILD_APPSTORE_UPLOAD",
                                     description: "xcodebuild is managing upload to appstore - skip all steps after running packaging",
                                     is_string: false,
                                     optional: true,
                                     default_value: false),
